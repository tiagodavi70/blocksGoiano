...
function runif(min, max, discrete) {
  ...
  exportsRand.runif = runif;
  exportsRand.rnorm = rnorm;
  exportsRand.rchisq = rchisq;
  exportsRand.rpoisson = rpoisson;
  exportsRand.rcauchy = rcauchy;
  exportsRand.rbernoulli = rbernoulli;
  exportsRand.rlist = rlist;
  
  exportsRand.rvunif = vectorize(runif);
  exportsRand.rvnorm = vectorize(rnorm);
  exportsRand.rvchisq = vectorize(rchisq);
  exportsRand.rvpoisson = vectorize(rpoisson);
  exportsRand.rvcauchy = vectorize(rcauchy);
  exportsRand.rvbernoulli = vectorize(rbernoulli);
  exportsRand.rvlist = vectorize(rlist);
  
  exportsRand.histogram = histogram;

  var randgen = exportsRand;